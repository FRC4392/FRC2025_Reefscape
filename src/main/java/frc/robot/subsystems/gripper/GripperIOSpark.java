...
public class GripperIOSpark implements GripperIO {
        ...
        var coralConfig = new SparkMaxConfig();
                ...
                tryUntilOk(
                                ...
                                () -> algaeMotor.configure(
                                                coralConfig, ResetMode.kResetSafeParameters,
    ...
    public void updateInputs(GripperIOInputs inputs) {
        sparkStickyFault = false;
                ...
                sparkStickyFault = false;
                ifOk(algaeMotor, algaeEncoder::getVelocity, (value) -> inputs.algaeMotorVelocityRadPerSec = value);
                ifOk(
                                algaeMotor,
