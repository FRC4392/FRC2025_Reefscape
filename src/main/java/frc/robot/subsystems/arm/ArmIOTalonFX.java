...
public class ArmIOTalonFX implements ArmIO {
    ...
    public void updateInputs(ArmIOInputs inputs) {
        ...
        inputs.extensionMotor1PositionRad = Units.rotationsToRadians(extensionMotor1Position.getValueAsDouble());
        ...
        inputs.extensionMotor2PositionRad = Units.rotationsToRadians(extensionMotor2Position.getValueAsDouble());
