...
public class ArmIOTalonFX implements ArmIO {
        ...
        public ArmIOTalonFX() {
                ...
                pivotMotionMagicTorqueCurrentFOC = new MotionMagicTorqueCurrentFOC(
                                pivotMotor1.getPosition().getValue());

                extensionMotionMagicVoltage = new MotionMagicVoltage(extensionMotor1.getPosition().getValue());
                extensionMotionMagicDutyCycle = new MotionMagicDutyCycle(extensionMotor1.getPosition().getValue());
                extensionMotionMagicTorqueCurrentFOC = new MotionMagicTorqueCurrentFOC(
                                extensionMotor1.getPosition().getValue());
                ...
                wristMotionMagicTorqueCurrentFOC = new MotionMagicTorqueCurrentFOC(wristMotor.getPosition().getValue());
        ...
        public void updateInputs(ArmIOInputs inputs) {
                var pivot1Status = BaseStatusSignal.refreshAll(pivotMotor1AppliedVolts, pivotMotor1Current,
                                pivotMotor1Position,
                ...
                inputs.basePivotMotor1PositionRad = Units.rotationsToRadians(pivotMotor1Position.getValueAsDouble());
                inputs.basePivotMotor1VelocityRadPerSec = Units
                                .rotationsToRadians(pivotMotor1Velocity.getValueAsDouble());
                inputs.basePivotMotor1Temp = pivotMotor1Temp.getValueAsDouble();

                var pivot2Status = BaseStatusSignal.refreshAll(pivotMotor2AppliedVolts, pivotMotor2Current,
                                pivotMotor2Position,
                ...
                inputs.basePivotMotor2PositionRad = Units.rotationsToRadians(pivotMotor2Position.getValueAsDouble());
                inputs.basePivotMotor2VelocityRadPerSec = Units
                                .rotationsToRadians(pivotMotor2Velocity.getValueAsDouble());
                inputs.basePivotMotor2Temp = pivotMotor2Temp.getValueAsDouble();

                var pivot3Status = BaseStatusSignal.refreshAll(pivotMotor3AppliedVolts, pivotMotor3Current,
                                pivotMotor3Position,
                ...
                inputs.basePivotMotor3PositionRad = Units.rotationsToRadians(pivotMotor3Position.getValueAsDouble());
                inputs.basePivotMotor3VelocityRadPerSec = Units
                                .rotationsToRadians(pivotMotor3Velocity.getValueAsDouble());
                ...
                inputs.extensionMotor1PositionRad = Units
                                .rotationsToRadians(extensionMotor1Position.getValueAsDouble());
                inputs.extensionMotor1VelocityRadPerSec = Units
                                .rotationsToRadians(extensionMotor1Velocity.getValueAsDouble());
                ...
                inputs.extensionMotor2PositionRad = Units
                                .rotationsToRadians(extensionMotor2Position.getValueAsDouble());
                inputs.extensionMotor2VelocityRadPerSec = Units
                                .rotationsToRadians(extensionMotor2Velocity.getValueAsDouble());
                inputs.extensionMotor2Temp = extensionMotor2Temp.getValueAsDouble();

                var wristStatus = BaseStatusSignal.refreshAll(wristAppliedVolts, wristCurrent, wristPosition,
                                wristVelocity,
                                wristTemp);
                ...
                pivotMotor1.setControl(
                                switch (pivotControlType) {
                                        ...
                                        case TorqueCurrentFOC ->
                                                pivotMotionMagicTorqueCurrentFOC.withPosition(angle.getRotations());
                                });
        }
        ...
        public void setWrist(Rotation2d angle) {
                ...
                wristMotor.setControl(
                                switch (wristControlType) {
                                        ...
                                        case TorqueCurrentFOC ->
                                                wristMotionMagicTorqueCurrentFOC.withPosition(angle.getRotations());
                                });
